...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/TRAFFIC_LIGHT.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=uart/uart.c main.c button_matrix/button.c interrupt/interrupt.c timer/timer.c lcd/lcd.c i2c/i2c.c adc/adc.c pwm/pwm.c simulate_machine/simulate_machine.c led7seg/led7seg.c traffic_led/traffic_led.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/uart/uart.o ${OBJECTDIR}/main.o ${OBJECTDIR}/button_matrix/button.o ${OBJECTDIR}/interrupt/interrupt.o ${OBJECTDIR}/timer/timer.o ${OBJECTDIR}/lcd/lcd.o ${OBJECTDIR}/i2c/i2c.o ${OBJECTDIR}/adc/adc.o ${OBJECTDIR}/pwm/pwm.o ${OBJECTDIR}/simulate_machine/simulate_machine.o ${OBJECTDIR}/led7seg/led7seg.o ${OBJECTDIR}/traffic_led/traffic_led.o
POSSIBLE_DEPFILES=${OBJECTDIR}/uart/uart.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/button_matrix/button.o.d ${OBJECTDIR}/interrupt/interrupt.o.d ${OBJECTDIR}/timer/timer.o.d ${OBJECTDIR}/lcd/lcd.o.d ${OBJECTDIR}/i2c/i2c.o.d ${OBJECTDIR}/adc/adc.o.d ${OBJECTDIR}/pwm/pwm.o.d ${OBJECTDIR}/simulate_machine/simulate_machine.o.d ${OBJECTDIR}/led7seg/led7seg.o.d ${OBJECTDIR}/traffic_led/traffic_led.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/uart/uart.o ${OBJECTDIR}/main.o ${OBJECTDIR}/button_matrix/button.o ${OBJECTDIR}/interrupt/interrupt.o ${OBJECTDIR}/timer/timer.o ${OBJECTDIR}/lcd/lcd.o ${OBJECTDIR}/i2c/i2c.o ${OBJECTDIR}/adc/adc.o ${OBJECTDIR}/pwm/pwm.o ${OBJECTDIR}/simulate_machine/simulate_machine.o ${OBJECTDIR}/led7seg/led7seg.o ${OBJECTDIR}/traffic_led/traffic_led.o

# Source Files
SOURCEFILES=uart/uart.c main.c button_matrix/button.c interrupt/interrupt.c timer/timer.c lcd/lcd.c i2c/i2c.c adc/adc.c pwm/pwm.c simulate_machine/simulate_machine.c led7seg/led7seg.c traffic_led/traffic_led.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/TRAFFIC_LIGHT.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/i2c/i2c.o: i2c/i2c.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/i2c/i2c.o   i2c/i2c.c 
...
${OBJECTDIR}/pwm/pwm.o: pwm/pwm.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/pwm/pwm.o   pwm/pwm.c 
...
${OBJECTDIR}/simulate_machine/simulate_machine.o: simulate_machine/simulate_machine.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/simulate_machine/simulate_machine.o   simulate_machine/simulate_machine.c 
...
${OBJECTDIR}/led7seg/led7seg.o: led7seg/led7seg.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/led7seg" 
	@${RM} ${OBJECTDIR}/led7seg/led7seg.o.d 
	@${RM} ${OBJECTDIR}/led7seg/led7seg.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/led7seg/led7seg.o   led7seg/led7seg.c 
	@${DEP_GEN} -d ${OBJECTDIR}/led7seg/led7seg.o 
	@${FIXDEPS} "${OBJECTDIR}/led7seg/led7seg.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/traffic_led/traffic_led.o: traffic_led/traffic_led.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/traffic_led" 
	@${RM} ${OBJECTDIR}/traffic_led/traffic_led.o.d 
	@${RM} ${OBJECTDIR}/traffic_led/traffic_led.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/traffic_led/traffic_led.o   traffic_led/traffic_led.c 
	@${DEP_GEN} -d ${OBJECTDIR}/traffic_led/traffic_led.o 
	@${FIXDEPS} "${OBJECTDIR}/traffic_led/traffic_led.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/led7seg/led7seg.o: led7seg/led7seg.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/led7seg/led7seg.o.d 
	@${RM} ${OBJECTDIR}/led7seg/led7seg.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/led7seg/led7seg.o   led7seg/led7seg.c 
	@${DEP_GEN} -d ${OBJECTDIR}/led7seg/led7seg.o 
	@${FIXDEPS} "${OBJECTDIR}/led7seg/led7seg.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/traffic_led/traffic_led.o: traffic_led/traffic_led.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/traffic_led/traffic_led.o.d 
	@${RM} ${OBJECTDIR}/traffic_led/traffic_led.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/traffic_led/traffic_led.o   traffic_led/traffic_led.c 
	@${DEP_GEN} -d ${OBJECTDIR}/traffic_led/traffic_led.o 
	@${FIXDEPS} "${OBJECTDIR}/traffic_led/traffic_led.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/TRAFFIC_LIGHT.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/TRAFFIC_LIGHT.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/TRAFFIC_LIGHT.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/TRAFFIC_LIGHT.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
